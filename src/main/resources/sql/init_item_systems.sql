...
CREATE TABLE IF NOT EXISTS app_item (
  ...
  battle_start_passive_slot_count int DEFAULT 0 COMMENT '默认开战被动数量',
  player_default_edit_battle_start_passive_slot_count int DEFAULT 0,
  player_max_edit_battle_start_passive_slot_count int DEFAULT 0,
  battle_judge_passive_slot_count int DEFAULT 0 COMMENT '默认判定被动数量',
  player_default_edit_battle_judge_passive_slot_count int DEFAULT 0,
  player_max_edit_battle_judge_passive_slot_count int DEFAULT 0,
  battle_pulse_passive_slot_count int DEFAULT 0 COMMENT '默认脉冲被动数量',
  player_default_edit_battle_pulse_passive_slot_count int DEFAULT 0,
  player_max_edit_battle_pulse_passive_slot_count int DEFAULT 0,
  battle_combat_passive_slot_count int DEFAULT 0 COMMENT '默认战斗事件被动数量',
  player_default_edit_battle_combat_passive_slot_count int DEFAULT 0,
  player_max_edit_battle_combat_passive_slot_count int DEFAULT 0,
